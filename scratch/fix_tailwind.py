...
# Remove the two Script tags
code = re.sub(r'<Script.*?/>', '', code)
code = re.sub(r'<Script id="tailwind-config".*?</Script>', '', code, flags=re.DOTALL)
...
@theme {
  ...
  --color-tertiary-container: #00210a;
  --color-on-tertiary-fixed: #00210a;
  ...
  --color-on-secondary-fixed-variant: #0039b5;
  --color-tertiary-fixed-dim: #79db8d;
  --color-background: #f8f9ff;
  --color-on-surface: #0b1c30;
  --color-outline-variant: #c6c6cd;
  --color-secondary-container: #4069f2;
  --color-tertiary-fixed: #95f8a7;
  ...
  --color-on-secondary-fixed: #001551;
  --color-on-tertiary-fixed-variant: #005323;
  --color-on-tertiary: #ffffff;
  --color-surface-tint: #565e74;
  --color-inverse-surface: #213145;
  --color-on-tertiary-container: #339650;
  --color-surface-container-lowest: #ffffff;
  --color-secondary-fixed-dim: #b7c4ff;
  --color-primary-fixed-dim: #bec6e0;
  --color-surface: #f8f9ff;
  --color-on-primary-container: #7c839b;
  
  --font-headline-md: "Public Sans", sans-serif;
  --font-headline-sm: "Public Sans", sans-serif;
  --font-headline-lg: "Public Sans", sans-serif;
  ...
  --font-body-sm: "Public Sans", sans-serif;
  --font-headline-xl: "Public Sans", sans-serif;
  --font-headline-xl-mobile: "Public Sans", sans-serif;
}
"""
